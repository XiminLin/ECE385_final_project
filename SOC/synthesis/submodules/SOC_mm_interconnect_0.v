...
module SOC_mm_interconnect_0 (
	...
	wire  [97:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> nios2_qsys_0_jtag_debug_module_agent:cp_data
	...
	wire  [97:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> altpll_0_pll_slave_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // altpll_0_pll_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire  [11:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> altpll_0_pll_slave_agent:cp_channel
	...
	wire  [19:0] altpll_1_pll_slave_agent_m0_address;                                                // altpll_1_pll_slave_agent:m0_address -> altpll_1_pll_slave_translator:uav_address
	...
	wire  [98:0] altpll_1_pll_slave_agent_rf_source_data;                                            // altpll_1_pll_slave_agent:rf_source_data -> altpll_1_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [98:0] altpll_1_pll_slave_agent_rsp_fifo_out_data;                                         // altpll_1_pll_slave_agent_rsp_fifo:out_data -> altpll_1_pll_slave_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> altpll_1_pll_slave_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // altpll_1_pll_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire  [11:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> altpll_1_pll_slave_agent:cp_channel
	...
	wire  [97:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [19:0] keycode_s1_agent_m0_address;                                                        // keycode_s1_agent:m0_address -> keycode_s1_translator:uav_address
	...
	wire  [98:0] keycode_s1_agent_rf_source_data;                                                    // keycode_s1_agent:rf_source_data -> keycode_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] keycode_s1_agent_rsp_fifo_out_data;                                                 // keycode_s1_agent_rsp_fifo:out_data -> keycode_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> keycode_s1_agent:cp_data
	...
	wire  [19:0] otg_hpi_cs_s1_agent_m0_address;                                                     // otg_hpi_cs_s1_agent:m0_address -> otg_hpi_cs_s1_translator:uav_address
	...
	wire  [98:0] otg_hpi_cs_s1_agent_rf_source_data;                                                 // otg_hpi_cs_s1_agent:rf_source_data -> otg_hpi_cs_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] otg_hpi_cs_s1_agent_rsp_fifo_out_data;                                              // otg_hpi_cs_s1_agent_rsp_fifo:out_data -> otg_hpi_cs_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> otg_hpi_cs_s1_agent:cp_data
	...
	wire  [19:0] otg_hpi_address_s1_agent_m0_address;                                                // otg_hpi_address_s1_agent:m0_address -> otg_hpi_address_s1_translator:uav_address
	...
	wire  [98:0] otg_hpi_address_s1_agent_rf_source_data;                                            // otg_hpi_address_s1_agent:rf_source_data -> otg_hpi_address_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] otg_hpi_address_s1_agent_rsp_fifo_out_data;                                         // otg_hpi_address_s1_agent_rsp_fifo:out_data -> otg_hpi_address_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> otg_hpi_address_s1_agent:cp_data
	...
	wire  [19:0] otg_hpi_data_s1_agent_m0_address;                                                   // otg_hpi_data_s1_agent:m0_address -> otg_hpi_data_s1_translator:uav_address
	...
	wire  [98:0] otg_hpi_data_s1_agent_rf_source_data;                                               // otg_hpi_data_s1_agent:rf_source_data -> otg_hpi_data_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] otg_hpi_data_s1_agent_rsp_fifo_out_data;                                            // otg_hpi_data_s1_agent_rsp_fifo:out_data -> otg_hpi_data_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> otg_hpi_data_s1_agent:cp_data
	...
	wire  [19:0] otg_hpi_r_s1_agent_m0_address;                                                      // otg_hpi_r_s1_agent:m0_address -> otg_hpi_r_s1_translator:uav_address
	...
	wire  [98:0] otg_hpi_r_s1_agent_rf_source_data;                                                  // otg_hpi_r_s1_agent:rf_source_data -> otg_hpi_r_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] otg_hpi_r_s1_agent_rsp_fifo_out_data;                                               // otg_hpi_r_s1_agent_rsp_fifo:out_data -> otg_hpi_r_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> otg_hpi_r_s1_agent:cp_data
	...
	wire  [19:0] otg_hpi_w_s1_agent_m0_address;                                                      // otg_hpi_w_s1_agent:m0_address -> otg_hpi_w_s1_translator:uav_address
	...
	wire  [98:0] otg_hpi_w_s1_agent_rf_source_data;                                                  // otg_hpi_w_s1_agent:rf_source_data -> otg_hpi_w_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] otg_hpi_w_s1_agent_rsp_fifo_out_data;                                               // otg_hpi_w_s1_agent_rsp_fifo:out_data -> otg_hpi_w_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> otg_hpi_w_s1_agent:cp_data
	...
	wire  [97:0] nios2_qsys_0_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_0_jtag_debug_module_agent:rp_data -> router_004:sink_data
	...
	wire  [97:0] altpll_0_pll_slave_agent_rp_data;                                                   // altpll_0_pll_slave_agent:rp_data -> router_005:sink_data
	...
	wire         altpll_1_pll_slave_agent_rp_valid;                                                  // altpll_1_pll_slave_agent:rp_valid -> router_006:sink_valid
	wire  [97:0] altpll_1_pll_slave_agent_rp_data;                                                   // altpll_1_pll_slave_agent:rp_data -> router_006:sink_data
	wire         altpll_1_pll_slave_agent_rp_ready;                                                  // router_006:sink_ready -> altpll_1_pll_slave_agent:rp_ready
	wire         altpll_1_pll_slave_agent_rp_startofpacket;                                          // altpll_1_pll_slave_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         altpll_1_pll_slave_agent_rp_endofpacket;                                            // altpll_1_pll_slave_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [97:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [97:0] keycode_s1_agent_rp_data;                                                           // keycode_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [97:0] otg_hpi_cs_s1_agent_rp_data;                                                        // otg_hpi_cs_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [97:0] otg_hpi_address_s1_agent_rp_data;                                                   // otg_hpi_address_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [97:0] otg_hpi_data_s1_agent_rp_data;                                                      // otg_hpi_data_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [97:0] otg_hpi_r_s1_agent_rp_data;                                                         // otg_hpi_r_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [97:0] otg_hpi_w_s1_agent_rp_data;                                                         // otg_hpi_w_s1_agent:rp_data -> router_013:sink_data
	...
	wire         altpll_1_pll_slave_agent_rdata_fifo_src_valid;                                      // altpll_1_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] altpll_1_pll_slave_agent_rdata_fifo_src_data;                                       // altpll_1_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         altpll_1_pll_slave_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_004:in_0_ready -> altpll_1_pll_slave_agent:rdata_fifo_src_ready
